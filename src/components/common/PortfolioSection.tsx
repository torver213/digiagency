...
function PhotographyImageList() {
  return (
    ...
    <ImageList sx={{}} variant="woven" cols={3} gap={8}>
      {itemData5.map((item) => (
        <PhotoView key={item.img} src={`${item.img}?w=500&fit=crop&auto=format`}>
  ...
  return (
    <Box>
      <PhotoProvider>
        <ImageList variant="masonry" cols={3} gap={8}>
          {itemData.map((item) => (
            <PhotoView key={item.img} src={`${item.img}?w=500&fit=crop&auto=format&dpr=2`}>
              <ImageListItem key={item.img}>
                <img
                  srcSet={`${item.img}?w=248&fit=crop&auto=format&dpr=2 2x`}
                  src={`${item.img}?w=248&fit=crop&auto=format`}
    ...
    <Box sx={{ bgcolor: "background.paper", mt: 4 }}>
      <AppBar elevation={0} color="inherit" position="static">
        ...
        >
          ...
          <Tab label="Illustrator" {...a11yProps(1)} />
          <Tab label="Photoshop" {...a11yProps(2)} />
...
const PortfolioSection = () => {
  return (
    <React.Fragment>
      ...
      <Box sx={{ width: "100%", pt: { lg: 10, md: 10, sm: 0, xs: 0} }}>
        <Fade direction="right" duration={1400}>
          <Typography
            ...
            sx={{
              ...
              textTransform: "uppercase",
              textWrap: "wrap",
              fontSize: { lg: "3.75rem", md: "3.75rem", sm: "2rem", xs: "2rem" },
            }}
          >
            Our capabilities
          </Typography>
